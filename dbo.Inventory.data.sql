...
-- set [Body (HTML)] = replace([Body (HTML)], '<li>Comes with FAA 8130 form 3 </li>', '') 
...
select  title, [Original Price] , [Variant Price], ModifiedDate, cast(round([Variant Price], 2) as numeric(36,2))
from dbo.Inventory
where Vendor = 'hainan'
and [Original Price] >=100
